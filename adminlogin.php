...
if (!$conn) {
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "SELECT adminname FROM admin WHERE adminemail = '$adminemail' and adminpassword = '$adminpassword'";
...
<body>
    ...
    <form class="form-signin" method="POST">
        ...
        <input class="form-control" type="email" id="inputEmail" name="adminemail" required placeholder="Email address" autofocus />

        <input class="form-control" type="password" id="inputPassword" name="adminpassword" required placeholder="Password" />
        ...
        <a class="forgot-password" href="adminlogin">FORGOT PASSWORD</a>
